...
export default function SkillPreview({ name, level, icon }: SkillPreviewProps) {
  ...
  return (
    <div className="group">
      <div className="p-5 rounded-2xl bg-gradient-to-br from-white to-slate-50/50 dark:from-slate-800 dark:to-slate-900/50 border border-slate-200/80 dark:border-slate-700/80 shadow-md backdrop-blur-sm">
